...
class FaceRecognizer:
    def __init__(self, cfg):
        ...
        self.faceRecognitionModel.load_state_dict(torch.load(self.cfg))
        self.faceRecognitionModel.eval()
        self.faceRecognitionModel.to("cuda")
    ...
    def extractIdentity(self, inputImage:np.array)->torch.Tensor:
        ...
        with torch.no_grad():
            inputIdentity = self.faceRecognitionModel(inputImage.to("cuda"))
