...
class ResBlock2d(nn.Module):
    ...
    def __init__(self, in_features,out_features, kernel_size, padding):
        ...
        self.conv1 = lora.Conv2d(in_channels=in_features, out_channels=in_features, kernel_size=kernel_size,padding=padding, r=R)

        #self.conv2 = nn.Conv2d(in_channels=in_features, out_channels=out_features, kernel_size=kernel_size,padding=padding)

        self.conv2 = lora.Conv2d(in_channels=in_features, out_channels=out_features, kernel_size=kernel_size,padding=padding, r=R)

        if out_features != in_features:
            #self.channel_conv = nn.Conv2d(in_features,out_features,1)
            self.channel_conv = lora.Conv2d(in_features,out_features,1,r=R)
...
class UpBlock2d(nn.Module):
    ...
    def __init__(self, in_features, out_features, kernel_size=3, padding=1):
        ...
        self.conv = lora.Conv2d(in_channels=in_features, out_channels=out_features, kernel_size=kernel_size,padding=padding, r=R)
...
class DownBlock2d(nn.Module):
    ...
    def __init__(self, in_features, out_features, kernel_size=3, padding=1, stride=2):
        ...
        self.conv = lora.Conv2d(in_channels=in_features, out_channels=out_features, kernel_size=kernel_size,padding=padding, stride=stride, r=R)
...
class AdaAT(nn.Module):
    ...
    def __init__(self,  para_ch,feature_ch):
        ...
        self.commn_linear = nn.Sequential(
            lora.Linear(para_ch, para_ch, r=R),
            nn.ReLU()
        )
        self.scale = nn.Sequential(
                    lora.Linear(para_ch, feature_ch, r=R),
                    nn.Sigmoid()
                )
        ...
        self.translation = nn.Sequential(
                lora.Linear(para_ch, 2 * feature_ch, r=R),
                nn.Tanh()
            )
        self.tanh = nn.Tanh()
