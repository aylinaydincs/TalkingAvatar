...
class DataProcessingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--source_video_dir', type=str, default="25fps/USLU/Videos",
                            help='path of source video in 25 fps')
        self.parser.add_argument('--openface_landmark_dir', type=str, default="25fps/USLU/landmarks",
                            help='path of openface landmark dir')
        self.parser.add_argument('--video_frame_dir', type=str, default="25fps/USLU/split_video_25fps_frame",
                                 help='path of video frames')
        self.parser.add_argument('--audio_dir', type=str, default="25fps/USLU/split_video_25fps_audio",
                            help='path of audios')
        self.parser.add_argument('--deep_speech_dir', type=str, default="25fps/USLU/split_video_25fps_deepspeech",
                                 help='path of deep speech')
        self.parser.add_argument('--crop_face_dir', type=str, default="25fps/USLU/split_video_25fps_crop_face",
                            help='path of crop face dir')
        self.parser.add_argument('--json_path', type=str, default="25fps/USLU/training_json.json",
...
class DINetTrainingOptions():
    ...
    def parse_args(self):
        ...
        self.parser.add_argument('--non_decay', default=250, type=int, help='num of epoches with fixed learning rate')
        self.parser.add_argument('--decay', default=100, type=int, help='num of linearly decay epochs')
        self.parser.add_argument('--checkpoint', type=int, default=20, help='num of checkpoints in training stage')
        ...
        self.parser.add_argument('--pretrained_arcface_path',
                                 default='./asserts/Glint360Arcface.pth',
                                 type=str,
                                 help='Save data (.pth) of pretrained arcface')
        # =========================  Discriminator ==========================
