...
python train_DINet_frame.py --augment_num=32 --mouth_region_size=64 --batch_size=216 --result_path=./assert
s/training_model_weight/frame_training_64 --pretrained_syncnet_path=/media/syn-3090-2/M2SSD/aylin/X/DINet/asserts/syncnet_64mouth.pth 
```
...
python train_DINet_frame.py --augment_num=20 --mouth_region_size=256 --batch_size=12 --pretrained_syncnet_path=/media/syn-3090-2/M2SSD/aylin/X/DINet/asserts/syncnet_256mouth.pth --coarse2fine --coarse_model_path=./asserts/training_model_weight/frame_training_128/netG_model_epoch_1000.pth --result_path=./asserts/training_model_weight/frame_training_256
```
You can stop the training when the loss converges (we stop in about 200 epoch).
